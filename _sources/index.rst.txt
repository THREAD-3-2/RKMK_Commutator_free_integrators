...
Runge-Kutta-Munthe-Kaas and Comunntator free Lie group integrators are applied, as described in :ref:`Lie group integrators <int>`. The code can be run from a main file at `src/main.m`.
