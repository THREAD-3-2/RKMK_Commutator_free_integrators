...
Runge-Kutta-Munthe-Kaas and commutator free Lie group integrators are applied, as described in :ref:`Integration methods <int>`. The code can be run from 
a `main file <https://github.com/THREAD-3-2/RKMK_Commutator_free_integrators/blob/main/src/main.m>`_ at `src/main.m`.
